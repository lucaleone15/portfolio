...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[100dvh] pt-20 sm:pt-24 pb-4 sm:pb-6 border-b border-white/[0.06] overflow-hidden flex flex-col justify-between">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 w-full my-auto py-4 sm:py-6">
        <motion.div
        ...
        >
          ...
          {/* Subtitle with unbolded normal weight */}
