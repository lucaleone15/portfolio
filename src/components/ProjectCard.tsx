    ...
    >
      ...
      <div className="relative w-full flex flex-col h-full">
        ...
        >
          ...
          >
            <div className="px-4 py-2 sm:px-5 sm:py-2.5 rounded-full bg-black/85 backdrop-blur-xl border border-white/20 shadow-[0_16px_36px_rgba(0,0,0,0.8)] flex items-center gap-2 whitespace-nowrap">
              ...
              <ArrowUpRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#CCFF00]" />
            </div>
          </div>
        </div>
        ...
        <div className="pt-5 pb-1 flex flex-col justify-between flex-1 gap-3.5">
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              <h3 className="font-sans text-xl sm:text-2xl font-bold text-white tracking-tight group-hover:text-[#CCFF00] transition-colors truncate leading-snug">
                {project.title}
              </h3>
              {/* Date directly below title with green accent */}
